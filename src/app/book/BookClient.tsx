          ...
          <div className="mb-12 flex items-center justify-between">
            {[1, 2, 3, 4].map((s) => (
              <div key={s} className="flex items-center">
                <div
                  className={`flex h-10 w-10 items-center justify-center rounded-full text-sm font-semibold ${step >= s
                ...
                {s < 4 && (
                  <div
                    className={`h-0.5 w-12 sm:w-20 ${step > s ? "bg-[#4a9e6e]" : "bg-zinc-200 dark:bg-zinc-700"}`}
                  />
                )}
              </div>
            ))}
              ...
              <div className="mt-6 grid gap-3 sm:grid-cols-2">
                {serviceTypes.map((type) => (
                  <button
                    ...
                    className={`flex items-center gap-3 rounded-xl border-2 p-4 text-left transition-all ${selectedType === type.id
              ...
              <div className="mt-6 space-y-2">
                {(serviceOptions[selectedType] || []).map((service) => (
                  <button
                    ...
                    className={`w-full rounded-xl border-2 p-4 text-left transition-all ${selectedService === service
                      ? "border-[#4a9e6e] bg-[#4a9e6e]/5"
                      : "border-zinc-200 hover:border-zinc-300 dark:border-zinc-700"
                      }`}
                  >
                  ...
                  <div className="mt-2 flex gap-3">
                    {["Online", "In-person"].map((format) => (
                      <button
                        ...
                        className={`flex-1 rounded-xl border-2 p-3 text-sm font-medium transition-all ${formData.format === format.toLowerCase()
